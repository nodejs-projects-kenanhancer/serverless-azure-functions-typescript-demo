...
var FunctionAppService = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, utils_1.Utils.runWithRetry(function () {
    ...
    FunctionAppService.prototype.deploy = async function () {
        ...
        let deployment = await armService.createDeploymentFromType(type || "consumption");

        if (armTemplate) {
            let armDeployment = await armService.createDeploymentFromConfig(armTemplate);
